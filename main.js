...
function startGame()
{
   ...
   document.getElementById("status").style.marginBottom = "10px";
   document.getElementById("start").style.marginTop = "10px";
}
...
function models(){
    ...
    fill("black");
    noStroke();
    text("Width:"+width,185,20);
    text("Speed:"+abs(ball.dx),100,20);
    text("Height:"+height,285,20)
}
